...
import { Carbon16 } from '@carbon/icons-react';

import { Row, Grid, Column } from '@components/Grid';
import {
  footer,
  grid,
  nav,
      ...
      <Grid className={grid}>
        <Row>
          ...
          <Column
            ...
            colSm={3}
            offsetLg={2}>
            <Content buildTime={process.env.NEXT_PUBLIC_BUILD_TIME} />
          </Column>
        </Row>
        <Row>
          <Column colLg={3}>
...
const DefaultContent = () => (
  <>
    <p>
      ...
      that&#39;s used to display your site&#39;s build time: {process.env.NEXT_PUBLIC_BUILD_TIME}
    </p>
    <p>
      This value comes from <code>process.env.NEXT_PUBLIC_BUILD_TIME</code> and
      we update it using GitHub actions.
    </p>
    <p>
      <Link href="https://v11.carbondesignsystem.com" renderIcon={Carbon16}>
        Powered by Carbon Design System v11
      </Link>
    </p>
  </>
);
...
Footer.defaultProps = {
  links: {
    firstCol: [
      { href: '/', linkText: 'Work' },
      { href: '/', linkText: 'Expertise' },
      { href: '/', linkText: 'About' },
      { href: '/', linkText: 'Blog' },
      { href: '/', linkText: 'Careers' },
      { href: '/', linkText: 'Contact' },
    ],
    secondCol: [
      { href: '/', linkText: 'LinkedIn' },
      { href: '/', linkText: 'Twitter' },
      { href: '/', linkText: 'GitHub' },
      { href: '/', linkText: 'Slack' },
    ],
  },
